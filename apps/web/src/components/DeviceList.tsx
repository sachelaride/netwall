...
import { Search, Filter, Server, Laptop, Printer, Wifi, Shield, Trash2, ChevronUp, ChevronDown, Monitor } from 'lucide-react';
                ...
                <div className="bg-blue-600/10 border border-blue-500/20 rounded-lg p-4 flex items-center justify-between animate-in fade-in slide-in-from-top-4">
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="bg-red-600/20 hover:bg-red-600 border border-red-500/50 text-red-500 hover:text-white px-3 py-1 rounded text-sm transition-all flex items-center gap-2"
                        >
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            {device.agentId && (
                                                <button
                                                    ...
                                                    className="p-1.5 hover:bg-indigo-500/20 text-indigo-400 rounded-lg transition-colors group/remote"
                                                    title="Open Remote Desktop"
                                                >
                                                    <Monitor className="h-4 w-4 group-hover/remote:scale-110 transition-transform" />
                                                </button>
                                            )}
